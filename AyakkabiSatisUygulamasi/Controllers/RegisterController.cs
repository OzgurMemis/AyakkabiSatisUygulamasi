    ...
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Index(AppUserRegisterDto appUserRegisterDto)
        {
            ...
            if (result.Succeeded)
            {
                ...
                MailboxAddress mailboxAddressForm = new MailboxAddress("True Sneakers", "truesnekers@gmail.com");
                MailboxAddress mailboxAddressTo=new MailboxAddress("User",appuser.Email);
                mimeMessage.From.Add(mailboxAddressForm);
                mimeMessage.To.Add(mailboxAddressTo);
                BodyBuilder bodyBuilder = new BodyBuilder();
                bodyBuilder.TextBody = "Kayıt İşlemi Başarılı Bir Şekilde Gerçekleşti. Doğrulama Kodu: "+code;
                mimeMessage.Body=bodyBuilder.ToMessageBody();
                mimeMessage.Subject = "Ayakkabı Satış Uygulaması";
                SmtpClient client = new SmtpClient();
                client.Connect("smtp.gmail.com",587,false);
                client.Authenticate("truesnekers@gmail.com", "ovsy qyai rqpu lmon");
